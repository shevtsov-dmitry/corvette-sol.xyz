...
export default function WelcomePage() {
    return (
        <div className="max-w-dvw h-screen">
            ...
            {/*    autoplay={true}*/}
            {/*/>*/}
            <img src={"images/welcomePage/banner-first-on-ton.png"}
                 className={"absolute left-[21%] top-[15%] z-[100]"}/>
            ...
            <img src={"lotties/welcomePage/available-now.gif"}
                 className={'absolute bottom-[6%] right-[10%] w-[30%] max-mobile:w-[75%] max-mobile:bottom-[8%]'}/>
